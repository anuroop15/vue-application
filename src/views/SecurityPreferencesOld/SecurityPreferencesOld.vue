  ...
  <div class="container-fluid santander-security-pre_container">
    ...
    <div class="santander-security-pre_content mb-2">
      <section class="santander-security-pre_section">
        ...
        <div class="santander-security-pre_section-content p-3">
          <div class="row mb-2">
            ...
            <div class="col-12 col-md-6">
              <BaseInput :value="securityPreferenceOld.userName" disabled/>
            </div>
          </div>
          <div class="row mb-2">
            <div class="col-12 col-md-6">
          ...
          <div class="row justify-content-end mb-2">
            <div class="col-sm-2 align-self-end">
              <BaseButton
                variant="primary"
                @click="updateUserLoginName(userLoginName)"
              >{{$t('save')}}</BaseButton>
            </div>
          </div>
          <div class="row mb-2">
          ...
          <div class="row justify-content-end mb-2">
            <div class="col-sm-2 align-self-end">
              <BaseButton
                variant="primary"
                @click="updateOwnDisplayName(displayName)"
              >{{$t('save')}}</BaseButton>
            </div>
          </div>
        </div>
      ...
      <section class="santander-security-pre_section">
        ...
        <form @submit.prevent="startChangePassword">
          <div class="santander-security-pre_section-content p-3">
            <div class="row mb-2">
              <div class="col-12 col-md-6">
          ...
          <div class="row mb-2 santander-security-pre_image-phrase">
            <div class="col-sm-4 pr-5">
              ...
              <div class="col-12 mb-3 text-sm-center">
                 <img class="img-thumbnail float-md-right" v-if="siteToUserInfo.imagesURL" :src="siteToUserInfo.imagesURL">
              </div>
              </div>
              <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6"><BaseInput  required v-model="siteToUserInfo.phrase"/></div>
              </div>
            </div>
            <div class="col-sm-8">
              <p>{{$t('imageTitle')}}</p>
              ...
              <template v-for="image in imagesInfo">
                <div class="col-6 col-sm-3  mb-3 text-sm-center" :key="image.fakeName">
                  <img :class="{'img-thumbnail':true, selectedImages:selectedImages ===image.fakeName}" @click="selectImages(image.fakeName)" :src="image.imagesURL" :title="image.altText" :alt="image.altText">
                </div>
              </template>
              </div>
      ...
      <section class="santander-security-pre_section">
        ...
        <form @submit.prevent="changeSecurityQ">
          <div class="santander-security-pre_section-content p-3">
            <template
              v-for="(questionsInfo, index) in securityPreferenceOld.securityInfo.questionsInfo"
            >
            ...
            <div class="row justify-content-end mb-2">
              <div class="col-sm-6 align-self-end">
               <div class="d-flex justify-content-between">
                <BaseButton variant="primary" @click.prevent="seeSecurityQuestionsChallenger">{{$t('showSecurityAnswers')}}</BaseButton>
          ...
          <div class="row mb-2">
            <div class="col">
              <table class="table">
                ...
                <tbody>
                  <template v-for="device in securityPreferenceOld.securityInfo.devicesInfo">
                    <tr :key="device.label">
                      <td>{{device.label}}</td>
                      ...
                      <td>
                        <BaseButton
                          ...
                          @click="unbindDeviceStart(device.label)"
                        >
              ...
              <div class="santander-security-pre_phone" :key="phone.$model.key">
                <div class="row mt-4">
                  ...
                  <div class="col-8 col-md-4 order-2 order-md-2 santander-security-pre_phone-item">
                    <cool-select
                      v-model="phone.countryCode.$model"
                      :items="securityPreferenceOld.countryPrefixList.items || []"
                    ...
                    <div
                      class="santander-security-pre_alert"
                      role="alert"
                      v-if="!phone.countryCode.required"
                    >
                      <p>{{$t('areaCodeError')}}</p>
                    </div>
                  </div>
...
<script src="./SecurityPreferencesOld.js"></script>
<style scoped src="./SecurityPreferencesOld.css"></style>
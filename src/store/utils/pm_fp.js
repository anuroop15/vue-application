...
const stripFullPath = (tempFileName, lastDir) => {
...
const FingerPrint = function () {
  ...
  this.deviceprint_browser = function() {
    //alert('deviceprint_browser init');
    var userAgent = navigator.userAgent;
    var ua = userAgent.toLowerCase();
    var t = ua + SEP + navigator.appVersion + SEP + navigator.platform;
    //alert('deviceprint_browser ready, t: '+t);
    return t;
  };

  this.deviceprint_software = function() {
    //logDebug('deviceprint_software init...');
    var t = "";
    var isFirst = true;
    //alert('deviceprint_software init...');

    if (navigator.plugins.length > 0) {
      //alert('deviceprint_software, navigator.plugins.length: ' + navigator.plugins.length);
      var temp = "";
      var moz = "";
      var key = "";
      var plugin = "";
...
const IE_FingerPrint = () => {
  ...
  this.deviceprint_browser = function() {
    ...
    let t = ua + SEP + navigator.appVersion + SEP + navigator.platform;
    ...
    //alert('IE_FingerPrint... 1');

    t += SEP;
    //alert('IE_FingerPrint... 2');
    return t;
  };
  ...
  this.deviceprint_software = function deviceprint_software() {
    var t = "";
    var isFirst = true;
    //alert('deviceprint_software = deviceprint_software ...');
    ...
    try {
      ...
      for (let i = 0; i < components.length; i++) {
        ...
        var name = names[i];
        //alert('name/compVer: ' + name + '/' + compVer + ', i/n: ' + i + '/' + components.length);
 ...
 */
export const add_deviceprint = () => {
  /*
   * Browser Detection
   */
  BrowserDetect.init();
  let fp = null;
  //logDebug('add_deviceprint, detecting browser...' + BrowserDetect.browser);
  //alert('detecting browser: ' + BrowserDetect.browser);
 ...
 */
export const decode_deviceprint = () => {
